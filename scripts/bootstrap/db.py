...
def reset(configuration: Dict[str, Any]):
    ...
    fields = [
        ...
        FieldSchema(name="photo_id", dtype=DataType.VARCHAR, max_length=128, is_primary=False),
        FieldSchema(name="collection_id", dtype=DataType.VARCHAR, max_length=128, is_primary=False),
        FieldSchema(name="bbox", dtype=DataType.FLOAT_VECTOR, dim=4),
    ...
    collection.create_index("bbox", index_params)
